                        ...
                        <div className="space-y-3 border-t border-border pt-3">
                          ...
                          {cfg.playlistId && (
                            <div>
                              ...
                              <Select
                                value={cfg.playlistId}
                                onValueChange={(v) => updateCfg({ playlistId: v })}
                              >
                            ...
                            <div className="space-y-2">
                              ...
                              {slideItems.length === 0 ? (
                                <p className="text-[11px] text-muted-foreground italic">
                                  Aucune image. Cliquez sur "Ajouter" pour en sélectionner depuis la bibliothèque.
                                </p>
                              ) : (
                          ...
                          <div className="grid grid-cols-2 gap-2 border-t border-border pt-3">
                            <div>
                              ...
                              <Input
                                type="number"
                                min={1}
                                value={cfg.defaultDuration ?? 5}
                                onChange={(e) => updateCfg({ defaultDuration: Math.max(1, +e.target.value) })}
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                min={0}
                                step={100}
                                value={cfg.transitionDuration ?? 600}
                                onChange={(e) => updateCfg({ transitionDuration: Math.max(0, +e.target.value) })}
                                className="h-8 text-sm mt-1"
                              />
                            </div>
                          </div>
