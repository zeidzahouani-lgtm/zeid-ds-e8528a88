...
RETURNS TABLE(id uuid, code text, user_name text, user_id uuid, is_active boolean, expires_at timestamptz)
LANGUAGE plpgsql
...
BEGIN
  ...
  RETURN QUERY
  SELECT ac.id, ac.code, ac.user_name, ac.user_id, ac.is_active, ac.expires_at
